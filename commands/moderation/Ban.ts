...
import { Message, ChatInputCommandInteraction, GuildMember, PermissionFlagsBits } from 'discord.js'
import CavenBot from '../../structures/CavenBot'

export default class extends Command {
    constructor(client: CavenBot, name='ban') {
        super(client, name, {
            name: 'ban',
            category: 'Moderation',
    ...
    async run(message: Message, args: string[]) {
        ...
        let ban: GuildMember, reason: string
